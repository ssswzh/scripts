...
# Rscript ~/scripts/plot/plot_distribution.r file_name column column_name
...
if(args[3]=="Read_identity"){data[,colu] <- data[,colu]*100}
...
write.table(out, file = paste0(args[1],".",args[3],".txt"), row.names = FALSE, sep = "\t", quote = FALSE)
